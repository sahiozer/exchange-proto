...
/**
 * <pre>
 * ExchangeService for handling exchange rates from banks
 * </pre>
 */
...
public final class ExchangeServiceGrpc {
  ...
  public static final String SERVICE_NAME = "shared.ExchangeService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<shared.Exchange.EmptyRequest,
      shared.Exchange.BankRatesResponse> getGetBankRatesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBankRates",
  ...
  public static io.grpc.MethodDescriptor<shared.Exchange.EmptyRequest,
      shared.Exchange.BankRatesResponse> getGetBankRatesMethod() {
    io.grpc.MethodDescriptor<shared.Exchange.EmptyRequest, shared.Exchange.BankRatesResponse> getGetBankRatesMethod;
    if ((getGetBankRatesMethod = ExchangeServiceGrpc.getGetBankRatesMethod) == null) {
      synchronized (ExchangeServiceGrpc.class) {
        if ((getGetBankRatesMethod = ExchangeServiceGrpc.getGetBankRatesMethod) == null) {
          ExchangeServiceGrpc.getGetBankRatesMethod = getGetBankRatesMethod =
              io.grpc.MethodDescriptor.<shared.Exchange.EmptyRequest, shared.Exchange.BankRatesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBankRates"))
              ...
              .setSchemaDescriptor(new ExchangeServiceMethodDescriptorSupplier("GetBankRates"))
              .build();
        }
      }
    }
    return getGetBankRatesMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getBankRates(shared.Exchange.EmptyRequest request,
        io.grpc.stub.StreamObserver<shared.Exchange.BankRatesResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetBankRatesMethod(), responseObserver);
    }
  }
  ...
  public static final class ExchangeServiceStub
    ...
    /**
     */
    public void getBankRates(shared.Exchange.EmptyRequest request,
        io.grpc.stub.StreamObserver<shared.Exchange.BankRatesResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetBankRatesMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ExchangeServiceBlockingStub
    ...
    /**
     */
    public shared.Exchange.BankRatesResponse getBankRates(shared.Exchange.EmptyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetBankRatesMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ExchangeServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<shared.Exchange.BankRatesResponse> getBankRates(
        shared.Exchange.EmptyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetBankRatesMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_BANK_RATES = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BANK_RATES:
          serviceImpl.getBankRates((shared.Exchange.EmptyRequest) request,
              (io.grpc.stub.StreamObserver<shared.Exchange.BankRatesResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (ExchangeServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetBankRatesMethod())
              .build();
        }
      }
    }
